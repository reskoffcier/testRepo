...
namespace hms.Forms
{
    public partial class frmIndDoctorLedger : Form
    {
        C_Data_Batch objData = new C_Data_Batch();
        private string strErr = "";
        public frmIndDoctorLedger()
        {
            InitializeComponent();
        ...
        private void txtDoctorId_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
            {
                ...
                var sql = "USP_Doctor_Payment_Due_Amount " + docId + ",'A'," + Utility.DCP;
                ...
                strErr = "";
                var sqlReport = "rpt_Doctor_Ledger " + docId + ",'A'," + Utility.DCP;
                var dtDoctorLedger = objData.RetriveData(sqlReport, ref strErr);
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            ...
            objData.OpenConnection("AatickPC-Home", ref strErr);
            var sql = "INSERT INTO dbo_Doctor_Payment(Doc_Id,Paid_Amount,Paid_On,Paid_Type,Remarks) VALUES(" + docId + "," + paidAmount + ",getdate(),'A','" + txtremark.Text + "')";
